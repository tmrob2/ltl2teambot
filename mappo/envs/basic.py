...
class LTLSimpleMAEnv(MiniGridEnv):
    ...
    def complete_agent_rewards(self, agent_termination, rewards):
        full_agent_rewards = []
        for i in range(self.num_agents):
    ...
    def step(self, action):
        ...
        full_agent_rewards = self.complete_agent_rewards(terminated_, reward)
        terminated = self.mission_terminate()

        return obs, full_agent_rewards, terminated, truncated, info
